...
@protocol XCDYouTubeVideoPlayerViewControllerDelegete <NSObject>
...
//デリゲート
@property (nonatomic, unsafe_unretained) id <XCDYouTubeVideoPlayerViewControllerDelegete> delegete;
@end
